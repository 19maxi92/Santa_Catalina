...
// Cola de impresión automática (comandas y cajón): vive en su propio archivo,
// para que un deploy que no actualice config.php no deje el cajón sin funcionar.
require_once __DIR__ . '/cola_impresion.php';
?>